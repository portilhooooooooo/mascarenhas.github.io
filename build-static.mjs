...
// Stable filenames receive the current commit as their cache version. This is
// important for the local tunnel too: switching branches or pulling a new
// workspace commit must never leave the browser using an older JS/CSS bundle.
...
const builtIndexHtml = indexHtml
  ...
  .replace('</head>', `  <link rel="stylesheet" href="/tasks.css?v=${buildVersion}">\n  <link rel="icon" type="image/svg+xml" href="/favicon.svg?v=${buildVersion}">\n</head>`)
