...
await writeFile(
  indexPath,
  indexHtml
    .replace(/dashboard-react\.css\?v=[^"']+/g, 'dashboard-react.css?v=20260911-protocolos-react-v1')
    .replace(/dashboard-react\.js\?v=[^"']+/g, 'dashboard-react.js?v=20260911-protocolos-react-v1'),
  'utf8'
);
