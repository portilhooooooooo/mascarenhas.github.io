...
await writeFile(
  indexPath,
  indexHtml
    .replace(/dashboard-react\.css\?v=[^"']+/g, 'dashboard-react.css?v=20260912-sidebar-architecture-v2')
    .replace(/dashboard-react\.js\?v=[^"']+/g, 'dashboard-react.js?v=20260912-sidebar-architecture-v2'),
  'utf8'
);
