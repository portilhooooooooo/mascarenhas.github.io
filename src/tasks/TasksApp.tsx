...
export function TasksApp() {
  ...
  const [selectedStatus, setSelectedStatus] = useState<TaskStatusFilter>('urgent');
  ...
  useEffect(() => {
    if (selectedStatus === 'all' || statusCounts[selectedStatus] > 0) return;
