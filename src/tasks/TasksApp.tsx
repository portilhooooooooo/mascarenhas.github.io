...
export function TasksApp() {
  ...
  const [activeDefenseIndication, setActiveDefenseIndication] = useState<string | null>(null);
  ...
  useEffect(() => { setActiveDefenseIndication(null); }, [activeKey]);
