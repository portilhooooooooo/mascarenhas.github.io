...
export function AgreementsIndicatorsSection() {
  ...
  return <section className="agreements-section" aria-labelledby="agreements-indicators-title">
    <header className="agreements-heading"><div><h2 id="agreements-indicators-title">ACORDOS — RESUMO POR SITUAÇÃO E TAREFA</h2><p>Indicadores calculados diretamente da carteira de acordos.</p></div><div className="agreements-totals"><span><small>REGISTROS</small><strong>{formatNumberBR(data.summary.total)}</strong></span></div></header>
