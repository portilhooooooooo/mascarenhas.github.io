...
- Supabase REDACTED_SUPABASE_PROJECT inspecionado por SQL somente leitura. processos_carteira possui product, situation_benner, situation_cpj, date_resolution e updated_at. acordos_carteira não possui origem_acordo. Ambas têm RLS habilitada e não há grants diretos para anon/authenticated.
